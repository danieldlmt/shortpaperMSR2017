...
\begin{abstract}
The rising tide of Operating Systems (OS) and platforms creates a surge in demand for libraries and frameworks that assist developers in building cross-platform applications. But anyhow there is a lack of knowledge about the development process of such libraries and frameworks in Software Engineering. With the goal of contributing to the community in understanding the singularities in the development of cross-platform libraries, we conducted a case of study with Allegro, a well succeeded cross-platform library project written in C. To accomplish our goal, we extracted the changelog from Allegro's repository and data mined the commits in order to perform a quantitative analysis on data to investigate dependencies among platforms Allegro supports. We also raise the developer team profile to investigate the number of platforms that core and peripheral developers support and if there is a clear separation between mobile and desktop developer team. We found that 30\% of developers are specialized in a single platform and there is no specialized developer in the core team. Moreover, we also realized a segregation in mobile and desktop development, only about 20\% of developers work with both mobile and desktop platforms. Among other assumptions, the analysis suggests that exist a barricade between mobile and desktop development even in a cross-platform software as Allegro. Nevertheless, this study must be conducted with other cross-platforms libraries and frameworks to more consistent assumptions.   

\todo[inline]{Problem: lack of knowledge about how such libraries and frameworks are developed.}
\todo[inline]{Goal: measure the level of specialization of developers of cross-platform libs and the knowledge of developers about distinct platforms}

\todo[inline]{Results}
\todo[inline]{Impact of the results}
